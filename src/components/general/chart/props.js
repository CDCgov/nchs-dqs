...
export const getProps = (props) => {
	return {
		...
		noDataMessage: props.noDataMessage || "There are no data for your selections. Please change your options.", // message to be displayed in place of chart when no data array is passed into genChart (CVI-4549 Tech Debt: Display message to user when no data is passed into genChart component)
