...
const singleTopicDatasets = {
	...
	"post-natal-deaths": {
		...
		dataUrl:
			"https://data.cdc.gov/National-Center-for-Health-Statistics/DQS_Infant-neonatal-and-postneonatal-mortality-rat/m7w3-utaq",
		private: "1",
		socrataId: "m7w3-utaq",
		chartTitle: "Infant, neonatal, and postneonatal death rates",
		filters: "HUS,NVSS",
		dataSystem: "HUS,NVSS",
		classificationId: 1,
		yAxisUnitId: 1,
		...
		topicGroup: 6,
		subtopics: [
			{ id: "1", text: "All infant deaths" },
			{ id: "2", text: "Neonatal deaths" },
			{ id: "3", text: "Postneonatal deaths" },
		],
	},
};
