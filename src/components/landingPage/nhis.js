...
const NHAMCSChild = [
	{
		...
		subtopics: [
			...
			{ id: "9", text: "Back symptoms" },
			{ id: "2", text: "Chest pain and related symptoms (not referable to body systems)" },
			{ id: "5", text: "Cough" },
			{ id: "3", text: "Fever" },
			{ id: "6", text: "Headache, pain in head" },
			{ id: "8", text: "Other symptoms/problems related to psychological and mental disorders" },
			{ id: "7", text: "Pain, site not referable to a specific body system" },
			{ id: "4", text: "Shortness of breath" },
			{ id: "1", text: "Stomach and abdominal pain, cramps and spasms" },
			{ id: "10", text: "Vomiting" },
		],
	},
	{
		...
		subtopics: [
			...
			{ id: "5", text: "Diseases of the digestive system" },
			{ id: "6", text: "Diseases of the genitourinary system" },
			{ id: "4", text: "Diseases of the musculoskeletal system and connective tissue" },
			{ id: "3", text: "Diseases of the respiratory system" },
			{ id: "9", text: "Diseases of the skin and subcutaneous tissue" },
			{ id: "2", text: "Injury and poisoning" },
			{ id: "7", text: "Mental, behavioral, and neurodevelopmental disorders" },
			{ id: "1", text: "Symptoms, signs, and abnormal clinical and laboratory findings" },
		],
	},
];
