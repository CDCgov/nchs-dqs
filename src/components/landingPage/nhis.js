...
const NHISAdult = [
	...
	{ id: "current-asthma", text: "Current asthma in adults", topicGroup: 1 },
	...
	{ id: "prostate-cancer", text: "Prostate cancer", topicGroup: 3, excludedFilters: ["Female"] },
	{
	...
	{ id: "uninsured-for-more-than-one-year", text: "Uninsured for more than one year", topicGroup: 10 },
	{
...
const NHAMCSChild = [
	{
		...
		subtopics: [
			...
			{ id: "15", text: "Cough" },
			{ id: "16", text: "Fever" },
			{ id: "17", text: "Headache, pain in head" },
	...
	},
	{
		...
		indicator: "Hospital emergency department visits by primary diagnosis:",
		topicGroup: 13,
		subtopics: [
			{ id: "1", text: "All diagnoses" },
			{ id: "2", text: "Certain infectious and parasitic diseases" },
			{ id: "3", text: "Diseases of the circulatory system" },
			{ id: "4", text: "Diseases of the digestive system" },
			{ id: "5", text: "Diseases of the genitourinary system" },
			{ id: "6", text: "Diseases of the musculoskeletal system and connective tissue" },
			{ id: "7", text: "Diseases of the respiratory system" },
			{ id: "8", text: "Diseases of the skin and subcutaneous tissue" },
			{ id: "9", text: "Injury and poisoning" },
			{ id: "10", text: "Mental, behavioral, and neurodevelopmental disorders" },
			{ id: "11", text: "Symptoms, signs, and abnormal clinical and laboratory findings" },
		],
	},
];
...
export const NHISTopics = [
	...
	...NHISChild.map((d) => ({
		...
		dataSystem: "NHIS",
		filters: ["Children", "Indian"],
		excludedFilters: ["Older", "Infants", "Adults", "PacificIslander"],
	})),
	...NHAMCSChild.map((d) => ({
		...d,
		skipSubtopics: true,
	...
	...NHANESOralHealth.map((d) => ({
		...
		excludedFilters: [
			...
			"Indian",
			"PacificIslander",
			!d.filters.includes("Adults") ? "Adults" : null,
		].filter((f) => f),
	})),
	...
	...WONDERHUSHeartDisease.map((d) => ({
		...d,
		dataSystem: "HUS,NVSS",
		filters: ["HUS", "NVSS", "Infants", "Children", "PacificIslander"],
